...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      reqParams.append('query',this.query);
      reqParams.append('productLabel',this.productLabel);
      reqParams.append('startDate',this.startDate);
      reqParams.append('endDate',this.endDate);
      this.$http.post('http://127.0.0.1:3000/api/getOrderList', reqParams)
      .then((res) => {
