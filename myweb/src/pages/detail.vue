	...
	<div class="detail-wrap">
		<div class="detail-left">
			<div class="product-board">
				...
				<ul>
					<li v-for="item in productss">
						<router-link :to="{ path: item.path}" tag='p' active-class="active">{{ item.name }}</router-link>
					</li>
				</ul>
			</div>
		</div>
...
.product-board li p.active,
.product-board li p:hover {
	background: #4fc08d;
	color: #fff;
}
.product-board li a {
